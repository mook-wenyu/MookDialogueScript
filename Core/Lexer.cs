...
namespace MookDialogueScript
{
    public class Lexer
    {
        ...
        private Token HandleIndentation()
        {
            ...
            if (_currentChar != '\0' && _currentChar != '\n' && _currentChar != '\r' && _currentChar != '/')
            {
                ...
                else if (indent < _currentIndent)
                {
                    ...
                    {
                        Console.WriteLine($"Invalid indentation at line {_line}, column {_column}");
                        return null;
                    }
                ...
                {
                    Console.WriteLine($"Inconsistent indentation at line {_line}, column {_column}");
                    return null;
                }
            }
        ...
        private Token HandleString()
        {
            ...
            Console.WriteLine($"Unterminated string at line {_line}, column {_column}");
            return null;
        }
            ...
            while (_currentChar != '\0')
            {
                ...
                switch (_currentChar)
                {
                    ...
                    case '&':
                        ...
                        Console.WriteLine($"Invalid character sequence at line {_line}, column {_column}");
                        return null;
